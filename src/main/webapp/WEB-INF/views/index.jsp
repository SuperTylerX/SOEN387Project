    ...
    <div class="right-main-box">
                ...
                <div class="chat-content">
                    <div class="chat-content-info">
                        <div class="chat-content-meta">
                            <span class="chat-name">David</span>
                            <span class="chat-time">2020-09-26 21:23</span>
                        </div>
                    </div>
        ...
        <div class="typing-box">
            <form action="./post" method="POST" id="chatting-form">
                ...
                <input type="text" class="form-control" placeholder="Say Something..." name="content" autocomplete="off">
                <button type="submit" class="btn btn-primary active btn-sm">Send</button>
            </form>
        </div>
    </div>
</div>
